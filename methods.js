...
//MAP
// let numbers = [4, 9, 16, 25, 36, 49, 64, 81];
...
//FLATMAP
// let numbers = [[4, 9], [16, 25], [36, 49], [64, 81]]; //sub-arrays in an array
...
function someFunc(moreArr, xVal) {
    ...
    for (let i = 0; i < moreArr.length; i++) {
        if (newNew[i] >= xVal) {
            ...
            console.log(`${newNew[i]} : squareroot above or equal to 5 [👇]`);
            
        } 
        else {
           console.log(`${newNew[i]} : squareroot not above 5 [❌]`); 
        }
